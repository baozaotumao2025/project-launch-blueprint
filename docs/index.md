...
> 这里记录从零开始推进这个 skill 的每一步定义、验证点和交付物。
> 先把“安装 skill 之后项目里会发生什么”定清楚，再定义项目边界、资产分类、阶段推进和最终交付。

## Steps

- [Step 00: command plan](./step-00-command-plan.md)
- [Step 01: skill installation and artifact contract](./step-01-skill-installation-and-artifact-contract.md)
